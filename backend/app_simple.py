#!/usr/bin/env python3
"""
AirGuard Backend API - Simple Version
Serves CSV data for air quality monitoring without ML models
"""
...
def predict_aqi(city):
    ...
    if "cdmx" in city_lower or "mexico" in city_lower:
        city_key = "cdmx"
    elif "la" in city_lower or "losangeles" in city_lower:
        city_key = "la"
    else:
        return jsonify({"error": "City not supported for prediction."}), 400
...
if __name__ == '__main__':
    print("Starting AirGuard Backend API (Simple Version)...")
    print("=" * 50)
